/* Copyright 2022 @ Keychron (https://keychron.com)
 * Copyright 2023 @ Asaduzzaman Pavel <contact@iampavel.dev>
 *
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_tkl_f13_ansi(
        KC_ESC,   KC_BRID,  KC_BRIU,  KC_NO,    KC_NO,    RGB_VAD,  RGB_VAI,  KC_MPRV,  KC_MPLY,  KC_MNXT,  KC_MUTE,  KC_VOLD,  KC_VOLU,    KC_MUTE,  KC_NO,    TG(NUMPAD),  RGB_MOD,
    ...
    /*
     * ,---------------------------------------------------------------------------------------------------------------------------.
     * | ESC   |  F1  |  F2  |  F3  |  F4  |  F5  |  F6  |  F7  |  F8  |  F9  | F10  | F11  | F12  | MUTE | PRINT | SCROLL | PAUSE |
     * |-------+------+------+------+------+-------------+------+------+------+------+------+------+------+-------+--------+-------|
    ...
    [WIN_BASE] = LAYOUT_tkl_f13_ansi(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,     KC_MUTE,  KC_PSCR,  TG(NUMPAD), RGB_MOD,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,     KC_BSPC,  KC_INS,   KC_HOME,    KC_PGUP,
        KC_TAB,   KC_Q,     KC_W,     KC_E,     KC_R,     KC_T,     KC_Y,     KC_U,     KC_I,     KC_O,     KC_P,     KC_LBRC,  KC_RBRC,    KC_BSLS,  KC_DEL,   KC_END,     KC_PGDN,
        KC_ESC,   KC_A,     KC_S,     KC_D,     KC_F,     KC_G,     KC_H,     KC_J,     KC_K,     KC_L,     KC_SCLN,  KC_QUOT,              KC_ENT,
        KC_LSFT,            KC_Z,     KC_X,     KC_C,     KC_V,     KC_B,     KC_N,     KC_M,     KC_COMM,  KC_DOT,   KC_SLSH,              KC_RSFT,            KC_UP,
...
bool rgb_matrix_indicators_user(void) {
    ...
    switch (layer) {
        case NUMPAD: // numpad layer
            ...
            // U I O P |
            NUMPAD_INDICATOR_COLOR(40);
            NUMPAD_INDICATOR_COLOR(41);
            NUMPAD_INDICATOR_COLOR(42);
            NUMPAD_INDICATOR_COLOR(43);
            NUMPAD_INDICATOR_COLOR(46);

            // J K L ;
            NUMPAD_INDICATOR_COLOR(57);
            NUMPAD_INDICATOR_COLOR(58);
            NUMPAD_INDICATOR_COLOR(59);
            NUMPAD_INDICATOR_COLOR(60);

            // Enter
            NUMPAD_INDICATOR_COLOR(62);

            // NM,.
            NUMPAD_INDICATOR_COLOR(69);
            NUMPAD_INDICATOR_COLOR(70);
            NUMPAD_INDICATOR_COLOR(71);
            NUMPAD_INDICATOR_COLOR(72);

            // RALT
            NUMPAD_INDICATOR_COLOR(80);
